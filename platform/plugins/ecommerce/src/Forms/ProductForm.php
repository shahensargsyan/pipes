...
class ProductForm extends FormAbstract
{
    ...
    public function buildForm()
    {
        ...
        $this
            ...
            ->add('head_title', 'text', [
                'label'      => trans('plugins/ecommerce::products.form.head_title'),
                'label_attr' => ['class' => 'text-title-field required'],
                'attr'       => [
                    'placeholder'  => trans('core/base::forms.head_title_placeholder'),
                    'data-counter' => 120,
                ],
            ])
            ->add('head_description', 'editor', [
                'label'      => trans('core/base::forms.head_description'),
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'rows'         => 2,
                    'placeholder'  => trans('core/base::forms.head_description_placeholder'),
                    'data-counter' => 1000,
                ],
            ])
            ->add('middle_title', 'text', [
                'label'      => trans('plugins/ecommerce::products.form.middle_title'),
                'label_attr' => ['class' => 'text-title-field required'],
                'attr'       => [
                    'placeholder'  => trans('core/base::forms.middle_title_placeholder'),
                    'data-counter' => 120,
                ],
            ])
            ->add('middle_description', 'editor', [
                'label'      => trans('core/base::forms.middle_description'),
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'rows'         => 2,
                    'placeholder'  => trans('core/base::forms.middle_description_placeholder'),
                    'data-counter' => 1000,
                ],
            ])
