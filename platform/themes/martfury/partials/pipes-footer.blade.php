...
<script src="/themes/pipes/lib/js/jquery-3.3.1.min.js"></script>
<script src="/themes/pipes/lib/bootstrap/js/bootstrap.min.js"></script>
<script src="/themes/pipes/lib/js/slick.js"></script>
<!-- Main JS -->
<script src="/themes/pipes/js/main-js.js"></script>
<script>
    jQuery(function(){
        console.log('sd')
