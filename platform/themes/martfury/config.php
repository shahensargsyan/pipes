...
//            $theme->asset()->container('footer')->usePath()->add('jquery', 'plugins/jquery-3.5.1.min.js');
            $theme->asset()->container('footer')->usePath()->add('jquery', 'pipes/lib/js/jquery-3.3.1.min.js');
